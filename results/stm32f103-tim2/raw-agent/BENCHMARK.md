...
- [FAIL] rc-w0 (0/5): SR implements rc_w0 and immediately recomputes IRQ — required patterns not all present
- [FAIL] compare (0/7): four output channels use the correct CCMR half and repeat per period — required patterns not all present
...
- [FAIL] qtest-timing (0/6): qtest covers reset and both sides of a timing boundary — required patterns not all present
- [FAIL] qtest-irq-compare (0/5): qtest covers IRQ assertion/clearing and output compare — required patterns not all present
